...
export const marqueeTestimonials = [
  '"Um mês absurdo de abençoado na agora empresa" \u2014 Tiago S.',
  '"28 dias pra monetizar um canal e 28 dias monetizado" \u2014 Vini',
  '"Agora posso dizer que virei o jogo com o YouTube" \u2014 Tiago S.',
  '"R$ 54 mil de receita estimada" \u2014 Vini',
  '"Gratidão demais por esse lugar, vocês são ouro" \u2014 Tiago S.',
]
...
export const finalCta = {
  countdownLabel: 'A imersão começa em',
...
export const faq = [
  { q: 'O que é a Imersão para Empresários?', a: 'São 3 encontros ao vivo com Cassiano Girardi nos dias 24, 25 e 26 de março, das 19h às 22h, onde você vai aprender como montar um modelo de negócio que fatura em dólar.' },
  { q: 'O que é esse modelo de negócio?', a: 'É um modelo de negócio no YouTube onde você não aparece. Os conteúdos são produzidos com inteligência artificial, publicados em inglês e monetizados em dólar pelo próprio YouTube.' },
  { q: 'A Imersão para Empresários é para mim?', a: 'Sim. A imersão foi feita para quem quer começar um novo negócio. Você não precisa ter experiência com YouTube.' },
